...
- **price_score** : A score we derive from a moving average that gives the coin some indication of an upward or downward trend based solely on the market value  
...
- **youtube** : Number of videos with descriptions that contain relevant terms  
